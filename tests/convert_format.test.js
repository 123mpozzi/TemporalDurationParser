...
describe('parseDuration', () => {
    it('test parsing day component', () => {
        ...
        (0, chai_1.expect)((0, convert_format_1.parseDayComponent)('P3Y14DT12H30M55S')).to.equal(61.2);
        (0, chai_1.expect)((0, convert_format_1.parseDayComponent)('T1H2M3S')).to.equal(-1);
        (0, chai_1.expect)((0, convert_format_1.parseDayComponent)('P3Y14.5DT12H30M55S')).to.equal(-1);
    });
